...
class WRWeekViewFlowLayout: UICollectionViewFlowLayout {
    ...
    public var minHour : Int = 0
    public var maxHour : Int = 24

    open var maxSectionHeight: CGFloat { return columnHeaderHeight + hourHeight * CGFloat(maxHour - minHour) }
    ...
    func prepareHorizontalTileSectionLayoutForSections(_ sectionIndexes: NSIndexSet) {
        ...
        let sectionHeight = nearbyint(hourHeight * 15 + sectionMargin.top + sectionMargin.bottom)
...
//        let height = datasource.wrWeekViewMaxHour
    ...
    func dateForTimeRowHeader(at indexPath: IndexPath) -> Date {
        ...
        components.hour = indexPath.item + minHour
